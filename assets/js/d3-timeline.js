...
(function () {
  d3.timeline = function() {
    ...
    var hover = function () {},
        ...
        width = null,
        height = null,
        tickFormat = { format: d3.time.format("%m %Y"),
        ...
        showBorderFormat = {marginTop: 25, marginBottom: 25, width: 1, color: colorCycle}
      ;
    ...
    function timeline (gParent) {
      ...
      g.append("g")
        .attr("class", "axis")
        .attr("transform", "translate(" + 0 +","+(7 + (itemHeight + itemMargin) * maxStack)+")")
        .call(xAxis);



        // DRAW ACHTERGROND LIJNEN 
        ...
        d.forEach( function(datum, index){
          ...
          //   // draw the chart
            ...
            .on("click", function (d, i) {
                ...
                window.location.href = 'http://wijnemenjemee.local/taak/renovatie-stations-gein-en-gaasperplaslijn/'+datum.slug;
          ...
          if (hasLabel) {
            gParent.append("text")
              .attr("class", "timeline-label")
              .attr("transform", "translate("+ 5 +","+ (itemHeight * 0.75 + margin.top + (itemHeight + itemMargin) * yAxisMapping[index])+")")
